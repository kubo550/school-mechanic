...
$query = "SELECT id, imie, nazwisko, telefon FROM mechanik WHERE id = $id";
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-wrapper">
            <form action="mechanicy.php" method="POST">
                ...
                <div class="text-center">
                    <button type="submit" name="editMechanik" class="btn btn-primary">Zapisz zmiany</button>
                </div>
            </form>
        </div>
    </div>
